...
void Footer::draw() {
    ...
    move.setFillColor(ThemeManager::instance().getCurrentTheme().primary());
    ...
    menu.setFillColor(ThemeManager::instance().getCurrentTheme().primary());
    ...
    close.setFillColor(ThemeManager::instance().getCurrentTheme().primary());

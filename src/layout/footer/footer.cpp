...
void Footer::draw() {
    ...
    move.setFillColor(Colors::PRIMARY); // or maybe sf::Color::Green for terminal vibes
    ...
    help.setFillColor(Colors::PRIMARY); // or maybe sf::Color::Green for terminal vibes
    ...
    menu.setFillColor(Colors::PRIMARY); // or maybe sf::Color::Green for terminal vibes
    ...
    close.setFillColor(Colors::PRIMARY); // or maybe sf::Color::Green for terminal vibes
